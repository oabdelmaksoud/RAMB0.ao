 ...
 * It will also simulate actions like file interaction and code generation.
 *
...
*   If the user issues a command (e.g., "start", "begin", "proceed", "do the first thing"):
    *   agentResponse: Acknowledge the command. Identify the *first uncompleted* sub-task from the 'Full Plan' (if sub-tasks exist in the taskDescription). State you are initiating it. Example: "Okay, I'll get started on that. I'm now initiating: '[Sub-Task Title]' with the [Agent Type]. I'll let you know how it goes. What's next?"
...
*   If the user asks a general question about the task:
    *   agentResponse: Answer concisely using 'Task Details' and 'Full Plan'. Then ask a follow-up like, "Does that help?" or "What other details can I provide?"
