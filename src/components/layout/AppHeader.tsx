...
import { Sun, Moon, UserCircle, Settings, LayoutDashboard } from 'lucide-react'; // Added LayoutDashboard for consistency if needed
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-background/95 px-4 shadow-sm backdrop-blur md:px-6">
      <div className="flex items-center gap-2 md:gap-4">
        <Link href="/portfolio-dashboard" className="flex items-center gap-2"> {/* Updated href */}
